...
##### loop 
data_path= '/Volumes/Data/Badea/Lab/mouse/fMRI_data_packages_for_Nariman/T1_mask_before_bin/'
files_list=os.listdir(data_path)
files_list = [s for s in files_list if "pred_mask" in s ]
output = '/Volumes/Data/Badea/Lab/mouse/fMRI_data_packages_for_Nariman/T1_mask_before_bin/'
