...
for file in T2_list:
    ...
    if not os.path.isfile(reorient_folder_path+"pred_mask_"+file): # check if mask exists 
        ...
        command2 = 'antsApplyTransforms -d 3 -e 0 --float  -u float -i '+ reoriented_path +  ' -r '  + refrence_image_path + ' -o ' + reoriented_path
